...
app.get('/api/dashboard/metrics', (req, res) => {
    ...
    if (demoMode) {
        ...
        res.json({
            ...
            resolvedMarkets: 0,
            constitutionalArticles: constitution.articles ? constitution.articles.length : 0,
            pendingAmendments: constitution.amendments ? constitution.amendments.filter(a => a.status === 'deliberation').length : 0,
            constitutionalViolations: constitution.violations ? constitution.violations.length : 0,
            activeTreaties: 0,
            totalTreaties: 0,
...
app.get('/agent-profile', (req, res) => {
    res.sendFile(path.join(__dirname, '../demo/agent-profile.html'));
});
...
// ============================================================
// STRUCTURED URL ROUTING — canonical subpaths + legacy 301 redirects
// ============================================================
app.get('/governance/debates', (req, res) => res.sendFile(path.join(__dirname, '../demo/debates.html')));
app.get('/governance/constitution', (req, res) => res.sendFile(path.join(__dirname, '../demo/constitution.html')));
app.get('/governance/amendments', (req, res) => res.sendFile(path.join(__dirname, '../demo/amendments.html')));
app.get('/governance/prediction-markets', (req, res) => res.sendFile(path.join(__dirname, '../demo/prediction-markets.html')));
app.get('/governance/simulate', (req, res) => res.sendFile(path.join(__dirname, '../demo/simulate.html')));
app.get('/governance/demo-run', (req, res) => res.sendFile(path.join(__dirname, '../demo/demo-run.html')));
app.get('/governance/vote-receipts', (req, res) => res.sendFile(path.join(__dirname, '../demo/vote-receipts.html')));
app.get('/governance/lifecycle', (req, res) => res.sendFile(path.join(__dirname, '../demo/lifecycle.html')));
app.get('/governance/delegation', (req, res) => res.sendFile(path.join(__dirname, '../demo/delegation.html')));
app.get('/governance/council', (req, res) => res.sendFile(path.join(__dirname, '../demo/council.html')));
app.get('/governance/appeals', (req, res) => res.sendFile(path.join(__dirname, '../demo/appeals.html')));
app.get('/governance/finalization', (req, res) => res.sendFile(path.join(__dirname, '../demo/finalization.html')));
app.get('/governance/execution-log', (req, res) => res.sendFile(path.join(__dirname, '../demo/execution-log.html')));
app.get('/governance/consensus', (req, res) => res.sendFile(path.join(__dirname, '../demo/consensus.html')));
app.get('/governance/slash-ledger', (req, res) => res.sendFile(path.join(__dirname, '../demo/slash-ledger.html')));
app.get('/governance/constitution-enforcement', (req, res) => res.sendFile(path.join(__dirname, '../demo/constitution-enforcement.html')));
app.get('/governance/constitutional-compliance', (req, res) => res.sendFile(path.join(__dirname, '../demo/constitutional-compliance.html')));
app.get('/governance/quorum-adaptation', (req, res) => res.sendFile(path.join(__dirname, '../demo/quorum-adaptation.html')));
app.get('/governance/federated-governance', (req, res) => res.sendFile(path.join(__dirname, '../demo/federated-governance.html')));
app.get('/security/collusion', (req, res) => res.sendFile(path.join(__dirname, '../demo/collusion.html')));
app.get('/security/drift', (req, res) => res.sendFile(path.join(__dirname, '../demo/drift.html')));
app.get('/security/oversight', (req, res) => res.sendFile(path.join(__dirname, '../demo/oversight.html')));
app.get('/security/reasoning', (req, res) => res.sendFile(path.join(__dirname, '../demo/reasoning.html')));
app.get('/security/alignment', (req, res) => res.sendFile(path.join(__dirname, '../demo/alignment.html')));
app.get('/security/stress-test', (req, res) => res.sendFile(path.join(__dirname, '../demo/stress-test.html')));
app.get('/security/watchdog', (req, res) => res.sendFile(path.join(__dirname, '../demo/watchdog.html')));
app.get('/security/peer-audit', (req, res) => res.sendFile(path.join(__dirname, '../demo/peer-audit.html')));
app.get('/security/emergency-response', (req, res) => res.sendFile(path.join(__dirname, '../demo/emergency-response.html')));
app.get('/security/intent-fidelity', (req, res) => res.sendFile(path.join(__dirname, '../demo/intent-fidelity.html')));
app.get('/analytics/scorecard', (req, res) => res.sendFile(path.join(__dirname, '../demo/scorecard.html')));
app.get('/analytics/roi', (req, res) => res.sendFile(path.join(__dirname, '../demo/roi-analytics.html')));
app.get('/analytics/health', (req, res) => res.sendFile(path.join(__dirname, '../demo/health-index.html')));
app.get('/analytics/systemic-risk', (req, res) => res.sendFile(path.join(__dirname, '../demo/systemic-risk.html')));
app.get('/analytics/audit-timeline', (req, res) => res.sendFile(path.join(__dirname, '../demo/audit-timeline.html')));
app.get('/analytics/audit', (req, res) => res.sendFile(path.join(__dirname, '../demo/audit-timeline.html')));
app.get('/analytics/velocity', (req, res) => res.sendFile(path.join(__dirname, '../demo/velocity.html')));
app.get('/analytics/snapshot', (req, res) => res.sendFile(path.join(__dirname, '../demo/snapshot.html')));
app.get('/analytics/governance-debt', (req, res) => res.sendFile(path.join(__dirname, '../demo/governance-debt.html')));
app.get('/analytics/correlation-observatory', (req, res) => res.sendFile(path.join(__dirname, '../demo/correlation-observatory.html')));
app.get('/analytics/accountability', (req, res) => res.sendFile(path.join(__dirname, '../demo/accountability.html')));
app.get('/analytics/prediction-oracle', (req, res) => res.sendFile(path.join(__dirname, '../demo/prediction-oracle.html')));
app.get('/analytics/outcome-auditor', (req, res) => res.sendFile(path.join(__dirname, '../demo/outcome-auditor.html')));
app.get('/analytics/judge-dashboard', (req, res) => res.sendFile(path.join(__dirname, '../demo/judge-dashboard.html')));
app.get('/analytics/learning', (req, res) => res.sendFile(path.join(__dirname, '../demo/learning.html')));
app.get('/analytics/knowledge-propagation', (req, res) => res.sendFile(path.join(__dirname, '../demo/knowledge-propagation.html')));
app.get('/analytics/gazette', (req, res) => res.sendFile(path.join(__dirname, '../demo/gazette.html')));
app.get('/analytics/decay', (req, res) => res.sendFile(path.join(__dirname, '../demo/decay.html')));
app.get('/analytics/sovereignty', (req, res) => res.sendFile(path.join(__dirname, '../demo/sovereignty.html')));
app.get('/analytics/incentives', (req, res) => res.sendFile(path.join(__dirname, '../demo/incentives.html')));
app.get('/analytics/liability-insurance', (req, res) => res.sendFile(path.join(__dirname, '../demo/liability-insurance.html')));
app.get('/identity/passport', (req, res) => res.sendFile(path.join(__dirname, '../demo/passport.html')));
app.get('/identity/trust', (req, res) => res.sendFile(path.join(__dirname, '../demo/trust-graph.html')));
app.get('/identity/reputation', (req, res) => res.sendFile(path.join(__dirname, '../demo/reputation.html')));
app.get('/identity/register', (req, res) => res.sendFile(path.join(__dirname, '../demo/register.html')));
app.get('/identity/agent-profile', (req, res) => res.sendFile(path.join(__dirname, '../demo/agent-profile.html')));
app.get('/identity/attestations', (req, res) => res.sendFile(path.join(__dirname, '../demo/attestations.html')));
app.get('/identity/reputation-recovery', (req, res) => res.sendFile(path.join(__dirname, '../demo/reputation-recovery.html')));
app.get('/identity/explainability', (req, res) => res.sendFile(path.join(__dirname, '../demo/explainability.html')));
app.get('/identity/succession-protocol', (req, res) => res.sendFile(path.join(__dirname, '../demo/succession-protocol.html')));
app.get('/identity/conflict-arbitration', (req, res) => res.sendFile(path.join(__dirname, '../demo/conflict-arbitration.html')));
app.get('/tools/interactive', (req, res) => res.sendFile(path.join(__dirname, '../demo/interactive.html')));
app.get('/tools/contracts', (req, res) => res.sendFile(path.join(__dirname, '../demo/contracts.html')));
app.get('/tools/docs', (req, res) => res.sendFile(path.join(__dirname, '../demo/docs.html')));
app.get('/tools/ai-governance', (req, res) => res.sendFile(path.join(__dirname, '../demo/ai-governance.html')));

// Legacy flat-path → canonical redirects (301 permanent)
app.get('/debates', (req, res) => res.redirect(301, '/governance/debates'));
app.get('/constitution', (req, res) => res.redirect(301, '/governance/constitution'));
app.get('/amendments', (req, res) => res.redirect(301, '/governance/amendments'));
app.get('/prediction-markets', (req, res) => res.redirect(301, '/governance/prediction-markets'));
app.get('/simulate', (req, res) => res.redirect(301, '/governance/simulate'));
app.get('/demo-run', (req, res) => res.redirect(301, '/governance/demo-run'));
app.get('/vote-receipts', (req, res) => res.redirect(301, '/governance/vote-receipts'));
app.get('/lifecycle', (req, res) => res.redirect(301, '/governance/lifecycle'));
app.get('/delegation', (req, res) => res.redirect(301, '/governance/delegation'));
app.get('/council', (req, res) => res.redirect(301, '/governance/council'));
app.get('/appeals', (req, res) => res.redirect(301, '/governance/appeals'));
app.get('/finalization', (req, res) => res.redirect(301, '/governance/finalization'));
app.get('/execution-log', (req, res) => res.redirect(301, '/governance/execution-log'));
app.get('/consensus', (req, res) => res.redirect(301, '/governance/consensus'));
app.get('/slash-ledger', (req, res) => res.redirect(301, '/governance/slash-ledger'));
app.get('/constitution-enforcement', (req, res) => res.redirect(301, '/governance/constitution-enforcement'));
app.get('/constitutional-compliance', (req, res) => res.redirect(301, '/governance/constitutional-compliance'));
app.get('/quorum-adaptation', (req, res) => res.redirect(301, '/governance/quorum-adaptation'));
app.get('/federated-governance', (req, res) => res.redirect(301, '/governance/federated-governance'));
app.get('/collusion', (req, res) => res.redirect(301, '/security/collusion'));
app.get('/drift', (req, res) => res.redirect(301, '/security/drift'));
app.get('/oversight', (req, res) => res.redirect(301, '/security/oversight'));
app.get('/reasoning', (req, res) => res.redirect(301, '/security/reasoning'));
app.get('/alignment', (req, res) => res.redirect(301, '/security/alignment'));
app.get('/stress-test', (req, res) => res.redirect(301, '/security/stress-test'));
app.get('/watchdog', (req, res) => res.redirect(301, '/security/watchdog'));
app.get('/peer-audit', (req, res) => res.redirect(301, '/security/peer-audit'));
app.get('/emergency-response', (req, res) => res.redirect(301, '/security/emergency-response'));
app.get('/intent-fidelity', (req, res) => res.redirect(301, '/security/intent-fidelity'));
app.get('/scorecard', (req, res) => res.redirect(301, '/analytics/scorecard'));
app.get('/roi-analytics', (req, res) => res.redirect(301, '/analytics/roi'));
app.get('/health-index', (req, res) => res.redirect(301, '/analytics/health'));
app.get('/systemic-risk', (req, res) => res.redirect(301, '/analytics/systemic-risk'));
app.get('/audit-timeline', (req, res) => res.redirect(301, '/analytics/audit-timeline'));
app.get('/audit', (req, res) => res.redirect(301, '/analytics/audit'));
app.get('/velocity', (req, res) => res.redirect(301, '/analytics/velocity'));
app.get('/snapshot', (req, res) => res.redirect(301, '/analytics/snapshot'));
app.get('/governance-debt', (req, res) => res.redirect(301, '/analytics/governance-debt'));
app.get('/correlation-observatory', (req, res) => res.redirect(301, '/analytics/correlation-observatory'));
app.get('/accountability', (req, res) => res.redirect(301, '/analytics/accountability'));
app.get('/prediction-oracle', (req, res) => res.redirect(301, '/analytics/prediction-oracle'));
app.get('/outcome-auditor', (req, res) => res.redirect(301, '/analytics/outcome-auditor'));
app.get('/judge-dashboard', (req, res) => res.redirect(301, '/analytics/judge-dashboard'));
app.get('/learning', (req, res) => res.redirect(301, '/analytics/learning'));
app.get('/knowledge-propagation', (req, res) => res.redirect(301, '/analytics/knowledge-propagation'));
app.get('/gazette', (req, res) => res.redirect(301, '/analytics/gazette'));
app.get('/decay', (req, res) => res.redirect(301, '/analytics/decay'));
app.get('/sovereignty', (req, res) => res.redirect(301, '/analytics/sovereignty'));
app.get('/incentives', (req, res) => res.redirect(301, '/analytics/incentives'));
app.get('/liability-insurance', (req, res) => res.redirect(301, '/analytics/liability-insurance'));
app.get('/passport', (req, res) => res.redirect(301, '/identity/passport'));
app.get('/trust', (req, res) => res.redirect(301, '/identity/trust'));
app.get('/trust-graph', (req, res) => res.redirect(301, '/identity/trust'));
app.get('/reputation', (req, res) => res.redirect(301, '/identity/reputation'));
app.get('/register', (req, res) => res.redirect(301, '/identity/register'));
app.get('/agent-profile', (req, res) => res.redirect(301, '/identity/agent-profile'));
app.get('/attestations', (req, res) => res.redirect(301, '/identity/attestations'));
app.get('/reputation-recovery', (req, res) => res.redirect(301, '/identity/reputation-recovery'));
app.get('/explainability', (req, res) => res.redirect(301, '/identity/explainability'));
app.get('/succession-protocol', (req, res) => res.redirect(301, '/identity/succession-protocol'));
app.get('/conflict-arbitration', (req, res) => res.redirect(301, '/identity/conflict-arbitration'));
app.get('/interactive', (req, res) => res.redirect(301, '/tools/interactive'));
app.get('/contracts', (req, res) => res.redirect(301, '/tools/contracts'));
app.get('/docs', (req, res) => res.redirect(301, '/tools/docs'));
app.get('/ai-governance', (req, res) => res.redirect(301, '/tools/ai-governance'));
